import { SERVICES, SITE_NAME, SITE_URL, MAILTO_HREF, BACKUP_EMAIL, FACEBOOK_URL } from "@/lib/site-config";
...
export const SERVICE_AREA_PAGES = [
  ...
  },
  {
    ...
    state: "TX",
    label: "Alvin, TX",
    title: "Top-Rated Handyman Services in Alvin, TX",
    description:
      "Small repairs and property maintenance for homes, rentals, and small businesses in Alvin, TX. Send project photos for a quote from MCS Handymen.",
    heroSub:
      "Trusted handyman help for homes, rentals & light commercial in Alvin, TX.",
  },
];
