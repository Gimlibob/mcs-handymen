...
// No public MCS phone yet — do not publish a placeholder in structured data.
// When a real number exists, set it here and wire it into buildLocalBusinessJsonLd.
export const PHONE_NUMBER = null;
export const PHONE_HREF = null;
